// ─────────────────────────────────────────────────────────────
// Donnees STATIQUES du theme NFT — commentees car non utilisees
// par l'integration catalog Prestige. Decommenter pour rollback.
// ─────────────────────────────────────────────────────────────
...
// Filters statiques inutilises pour Prestige (filtres dynamiques city/quartier desormais)
// export const STATUS_FILTERS = ['Buy now', 'New', 'On auction'];
// export const TYPE_FILTERS = ['Video', 'Image', '3D'];
// export const STATUS_MENU_IDS = [1766, 1767, 1768];
// export const TYPE_MENU_IDS = [5149, 5150, 5151];
...
// Garde-fou export pour eviter une erreur si un autre module importait
// encore ce fichier (rien d'autre ne devrait l'importer apres l'integration).
export {};
